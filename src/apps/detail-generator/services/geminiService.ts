...
import { GeneratedData, SpecContent, TextContent, FontSizes, FontStyles, HeroTextContent, HeroTextColors, NoticeContent, ImageAsset, CollageBlock } from '../DetailGeneratorApp';
...
// 4. **BACKGROUND**: Neutral grey concrete studio wall and floor. Soft shadows.`;
    ...
    if (topFile) {
        prompt += `\n// 5. **TOP REPLACEMENT**: Wear the provided \`TOP_IMAGE\`.`;
    }
    if (pantsFile) {
        prompt += `\n// 6. **BOTTOM REPLACEMENT**: Wear the provided \`BOTTOM_IMAGE\`.`;
    }
