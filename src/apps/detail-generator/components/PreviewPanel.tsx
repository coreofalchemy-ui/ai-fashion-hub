...
import { GeneratedData, FontSizes, FontStyles, HeroTextColors, ImageAsset, CollageBlock, PLACEHOLDER_ASSET } from '../DetailGeneratorApp';
...
export const PreviewPanel: React.FC<PreviewPanelProps> = ({ 
    ...
    const [isDraggingOverProductGallery, setIsDraggingOverProductGallery] = useState(false);
    ...
    useEffect(() => {
        const calculateOverlays = () => {
            ...
            images.forEach((img) => {
                ...
                newOverlays.push({
                    ...
                    type, galleryType, index, blockId, asset, isFirst, isLast
                });
            });
            setOverlays(newOverlays);

            // Section Item Overlays (for reordering sections)
        ...
        const observer = new MutationObserver(calculateOverlays);
    ...
    }, [htmlContent, imageUrls, collageBlocks]);
                ...
                {overlays.map((overlay, i) => {
                    ...
                    return (
                        <div 
                            ...
                            onDragOver={(e) => { e.preventDefault(); setDraggedOverImage({ galleryType: overlay.galleryType, index: overlay.index, blockId: overlay.blockId }); }}
