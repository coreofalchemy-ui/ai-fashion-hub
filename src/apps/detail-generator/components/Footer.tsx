...
const Footer: React.FC<FooterProps> = ({ isOnDressingScreen = false }) => {
  ...
  return (
    <footer className={`w-full bg-white/80 backdrop-blur-md border-t border-gray-200/60 p-3 z-50 ${isOnDressingScreen ? 'hidden sm:block' : ''}`}>
      <div className="mx-auto flex flex-col sm:flex-row items-center justify-end text-xs text-gray-600 max-w-7xl px-4">
